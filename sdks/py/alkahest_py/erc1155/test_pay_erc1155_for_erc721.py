...
from alkahest_py.barter_helpers import create_erc721_escrow, erc1155_payment_demand
...
async def test_pay_erc1155_and_collect(env, alice_client, bob_client):
    ...
    buy_result = await create_erc721_escrow(bob_client, bid_data, erc1155_payment_demand(env, ask_data, env.bob), 0)
