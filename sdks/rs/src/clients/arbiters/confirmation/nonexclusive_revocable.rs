...
impl ArbitersModule {
    ...
    /// Wait for a confirmation event from NonexclusiveRevocableConfirmationArbiter
    pub async fn wait_for_confirmation_nonexclusive_revocable(
        &self,
        fulfillment: FixedBytes<32>,
        escrow: FixedBytes<32>,
    ...
    > {
        let filter = Filter::new()
            ...
            .address(self.addresses.nonexclusive_revocable_confirmation_arbiter)
            .event_signature(
