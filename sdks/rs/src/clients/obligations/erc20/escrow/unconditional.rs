//! ERC20 unconditional escrow obligation client
//!
...
/// Unconditional escrow API for ERC20 tokens
...
impl<'a> Unconditional<'a> {
    ...
    pub fn address(&self) -> Address {
        // TODO: Add unconditional escrow address to Erc20Addresses when deployed
    ...
    pub async fn get_obligation(
        ...
        DecodedAttestation<
            contracts::obligations::escrow::unconditional::UnconditionalERC20EscrowObligation::ObligationData,
        >,
    > {
        let eas_contract =
        ...
        let obligation_data =
            contracts::obligations::escrow::unconditional::UnconditionalERC20EscrowObligation::ObligationData::abi_decode(
                &attestation.data,
            )?;
    ...
    pub async fn create(
        ...
        let escrow_obligation_contract =
            contracts::obligations::escrow::unconditional::UnconditionalERC20EscrowObligation::new(
                self.module.addresses.escrow_obligation_unconditional,
