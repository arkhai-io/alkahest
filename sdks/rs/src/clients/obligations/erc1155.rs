...
impl Erc1155Module {
    ...
    ///
    /// # Returns
    /// * `Result<contracts::obligations::escrow::non_tierable::ERC1155EscrowObligation::ObligationData>` - The decoded obligation data
    pub fn decode_escrow_obligation(
        obligation_data: &Bytes,
    ) -> eyre::Result<contracts::obligations::escrow::non_tierable::ERC1155EscrowObligation::ObligationData> {
        let obligation_data =
            contracts::obligations::escrow::non_tierable::ERC1155EscrowObligation::ObligationData::abi_decode(obligation_data)?;
    ...
    /// # Returns
    ///
    /// * `eyre::Result<contracts::obligations::ERC1155PaymentObligation::ObligationData>` - The decoded obligation data
    pub fn decode_payment_obligation(
        obligation_data: &Bytes,
    ) -> eyre::Result<contracts::obligations::ERC1155PaymentObligation::ObligationData> {
        let obligation_data =
            contracts::obligations::ERC1155PaymentObligation::ObligationData::abi_decode(obligation_data)?;
        return Ok(obligation_data);
    }
    ...
    pub async fn get_escrow_obligation(
        &self,
        uid: FixedBytes<32>,
    ) -> eyre::Result<DecodedAttestation<contracts::obligations::escrow::non_tierable::ERC1155EscrowObligation::ObligationData>> {
        let eas_contract = contracts::IEAS::new(self.addresses.eas, &*self.wallet_provider);

        let attestation = eas_contract.getAttestation(uid).call().await?;
        let obligation_data =
            contracts::obligations::escrow::non_tierable::ERC1155EscrowObligation::ObligationData::abi_decode(&attestation.data)?;
    ...
    pub async fn get_payment_obligation(
        ...
        let attestation = eas_contract.getAttestation(uid).call().await?;
        let obligation_data =
            contracts::obligations::ERC1155PaymentObligation::ObligationData::abi_decode(&attestation.data)?;
    ...
    pub async fn collect_escrow(
        ...
        let escrow_contract = contracts::obligations::escrow::non_tierable::ERC1155EscrowObligation::new(
    ...
    pub async fn buy_with_erc1155(
        ...
        let escrow_obligation_contract = contracts::obligations::escrow::non_tierable::ERC1155EscrowObligation::new(
            self.addresses.escrow_obligation,
            &*self.wallet_provider,
        );
    ...
    pub async fn buy_erc1155_for_erc1155(
        ...
        let barter_utils_contract =
            contracts::utils::ERC1155BarterUtils::new(self.addresses.barter_utils, &*self.wallet_provider);
    ...
    pub async fn buy_erc20_with_erc1155(
        ...
        let barter_utils_contract =
            contracts::utils::ERC1155BarterUtils::new(
