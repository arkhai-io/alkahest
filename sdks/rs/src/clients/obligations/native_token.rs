...
impl NativeTokenModule {
    ...
    ///
    /// # Returns
    /// * `Result<contracts::obligations::escrow::non_tierable::NativeTokenEscrowObligation::ObligationData>` - The decoded obligation data
    pub fn decode_escrow_obligation(
        ...
        let obligation_data =
            contracts::obligations::escrow::non_tierable::NativeTokenEscrowObligation::ObligationData::abi_decode(obligation_data)?;
    ...
    ///
    /// # Returns
    /// * `eyre::Result<contracts::obligations::NativeTokenPaymentObligation::ObligationData>` - The decoded obligation data
    pub fn decode_payment_obligation(
        obligation_data: &Bytes,
    ) -> eyre::Result<contracts::obligations::NativeTokenPaymentObligation::ObligationData> {
        let obligation_data =
            contracts::obligations::NativeTokenPaymentObligation::ObligationData::abi_decode(obligation_data)?;
        return Ok(obligation_data);
    }
    ...
    pub async fn get_escrow_obligation(
        &self,
        uid: FixedBytes<32>,
    ) -> eyre::Result<DecodedAttestation<contracts::obligations::escrow::non_tierable::NativeTokenEscrowObligation::ObligationData>>
    {
        let eas_contract = contracts::IEAS::new(self.addresses.eas, &*self.wallet_provider);

        let attestation = eas_contract.getAttestation(uid).call().await?;
        let obligation_data =
            contracts::obligations::escrow::non_tierable::NativeTokenEscrowObligation::ObligationData::abi_decode(&attestation.data)?;
    ...
    ) -> eyre::Result<DecodedAttestation<contracts::obligations::NativeTokenPaymentObligation::ObligationData>>
    {
        ...
        let attestation = eas_contract.getAttestation(uid).call().await?;
        let obligation_data =
            contracts::obligations::NativeTokenPaymentObligation::ObligationData::abi_decode(&attestation.data)?;
    ...
    pub async fn collect_escrow(
        ...
        let escrow_contract = contracts::obligations::escrow::non_tierable::NativeTokenEscrowObligation::new(
    ...
    pub async fn buy_with_native_token(
        ...
        let escrow_obligation_contract = contracts::obligations::escrow::non_tierable::NativeTokenEscrowObligation::new(
            self.addresses.escrow_obligation,
            &*self.wallet_provider,
        );
