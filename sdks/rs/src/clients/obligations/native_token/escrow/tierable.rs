//! Native Token tierable escrow obligation client
//!
...
/// Tierable escrow API for native tokens
...
impl<'a> Tierable<'a> {
    ...
    pub async fn get_obligation(
        ...
        DecodedAttestation<
            contracts::obligations::escrow::tierable::NativeTokenEscrowObligation::ObligationData,
        >,
    > {
        let eas_contract =
