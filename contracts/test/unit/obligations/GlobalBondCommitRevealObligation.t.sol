...
contract GlobalBondCommitRevealObligationTest is Test {
    GlobalBondCommitRevealObligation public obligation;
    ...
    function _obligationData() internal pure returns (GlobalBondCommitRevealObligation.ObligationData memory) {
    ...
    function testCommitRevealReclaimsBondAtomically() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(GlobalBondCommitRevealObligation.BondAlreadyClaimed.selector, commitment)
        );
    ...
    function testCheckObligationRevertsWithoutCommit() public {
        ...
        vm.prank(claimer);
        vm.expectRevert(
            abi.encodeWithSelector(GlobalBondCommitRevealObligation.CommitmentMissing.selector, commitment, claimer)
        );
    ...
    function testRevealRevertsIfSameBlock() public {
        ...
        vm.prank(claimer);
        vm.expectRevert(
            abi.encodeWithSelector(GlobalBondCommitRevealObligation.CommitmentTooRecent.selector, commitment, claimer)
        );
        obligation.doObligation(data, escrowUid);
    }
    ...
    function testMultipleCommitmentsEachReclaimable() public {
        ...
        GlobalBondCommitRevealObligation.ObligationData memory dataOld = GlobalBondCommitRevealObligation.ObligationData({
            payload: bytes("old"), salt: bytes32("salt-old"), schema: bytes32("schema-tag")
        });
        GlobalBondCommitRevealObligation.ObligationData memory dataNew = GlobalBondCommitRevealObligation.ObligationData({
    ...
    function testBondAmountUpdateTakesEffectNextBlock() public {
        ...
        GlobalBondCommitRevealObligation.ObligationData memory otherData =
            GlobalBondCommitRevealObligation.ObligationData({
    ...
    function testRevealRevertsAfterDeadline() public {
        ...
        vm.prank(claimer);
        vm.expectRevert(abi.encodeWithSelector(GlobalBondCommitRevealObligation.RevealTooLate.selector, commitment));
        obligation.doObligation(data, escrowUid);
    }
    ...
    function testSlashBondRevertsBeforeDeadline() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(GlobalBondCommitRevealObligation.CommitDeadlineNotReached.selector, commitment)
        );
        obligation.slashBond(commitment);
    }
    ...
    function testSlashBondToZeroAddress() public {
        ...
        GlobalBondCommitRevealObligation burnObligation =
            new GlobalBondCommitRevealObligation(eas, schemaRegistry, BOND, COMMIT_DEADLINE, address(0));
    ...
    function testDoObligationForRevertsWithWrongRecipientCommitment() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                GlobalBondCommitRevealObligation.CommitmentMissing.selector, expectedCommitment, splitter
            )
        );
