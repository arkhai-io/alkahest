...
contract DeployCrossTokenBarter is Script {
    function run() external {
        ...
        ERC20EscrowObligation erc20Escrow = ERC20EscrowObligation(payable(0x66F9e3Fa7CFc472fB61a3F61bE42558c80C0FC72));
        ERC20PaymentObligation erc20Payment =
            ERC20PaymentObligation(payable(0x417b73fF013c5E47639816c037e89aE053FD4A63));
        ERC721EscrowObligation erc721Escrow =
            ERC721EscrowObligation(payable(0x868e59ecd79067087Cac7447061b1436eD6C9417));
        ERC721PaymentObligation erc721Payment =
            ERC721PaymentObligation(payable(0x0F13f5c62D88BE6C85205A1A010511BF54269615));
        ERC1155EscrowObligation erc1155Escrow =
            ERC1155EscrowObligation(payable(0x93B7D9cdD97887a8f7603c77F12938bf3d1331F6));
        ERC1155PaymentObligation erc1155Payment =
            ERC1155PaymentObligation(payable(0x1395A7b129503E23eDAa7823b5F5994D65a26BF0));
        TokenBundleEscrowObligation bundleEscrow =
            TokenBundleEscrowObligation(payable(0x7cCE97b9552dFf0105eC96A46f5721764a24D9AC));
        TokenBundlePaymentObligation bundlePayment =
            TokenBundlePaymentObligation(payable(0x678f5601fe66485CEeD3d41D7385983881411c70));
